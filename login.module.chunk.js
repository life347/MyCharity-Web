...
module.exports = "<div class=\"login-page\" [@routerTransition]>\n    <div class=\"row\">\n        <div class=\"col-md-4 push-md-4\">\n            <img src=\"assets/images/logo.png\" width=\"150px\" class=\"user-avatar\" />\n            <h1>SB Admin BS4 Angular4</h1>\n            <form role=\"form\">\n                <div class=\"form-content\">\n                    <div class=\"form-group\">\n                        <input type=\"text\" name=\"user_credentials.user_id\" [value]=\"user_credentials.user_id\" (input)=\"user_credentials.user_id = $event.target.value\"  class=\"form-control input-underline input-lg\" id=\"\" placeholder=\"Email\">\n                    </div>\n\n                    <div class=\"form-group\">\n                        <input type=\"password\" name=\"user_credentials.password\" [value]=\"user_credentials.password\" (input)=\"user_credentials.password = $event.target.value\"  class=\"form-control input-underline input-lg\" id=\"\" placeholder=\"Password\">\n                    </div>\n                </div>\n                <a class=\"btn rounded-btn\" [routerLink]=\"['/dashboard']\" (click)=\"login()\"> Log in </a>\n                &nbsp;\n                <a class=\"btn rounded-btn\" [routerLink]=\"['/signup']\">Register</a>\n            </form>\n        </div>\n    </div>\n</div>\n"
...
var LoginComponent = (function () {
    ...
    LoginComponent.prototype.login = function () {
        var _this = this;
        this.db.object('admin').snapshotChanges().map(function (action) {
            var $key = action.payload.key;
            var data = __assign({ $key: $key }, action.payload.val());
            return data;
        }).subscribe(function (item) {
            _this.db_credentials.user_id = item.user_id;
            _this.db_credentials.password = item.password;
            // console.log("admin",this.db_credentials);
            // console.log("user",this.user_credentials);
            if (_this.user_credentials.user_id == _this.db_credentials.user_id && _this.user_credentials.password == _this.db_credentials.password) {
                console.log("Match");
                localStorage.setItem('isLoggedin', 'true');
