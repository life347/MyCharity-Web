...
module.exports = "\n\n<div [@routerTransition]>\n    <h2 class=\"text-muted\">Charities <small>Admin Panel</small></h2>\n    <div class=\"row\">\n        <div class=\"col-md-12\">\n            <div class=\"table-response\">\n                    <table class=\"table\">\n                            <thead class=\"thead-inverse\">\n                            <tr>\n                                \n                                <th>Address</th>\n                                <th>Category</th>\n                                <th>Name</th>\n                                <th>Needed Aid</th>\n                                <th>Phone</th>\n                                <th>Verified</th>\n                                <th>Website</th>\n                                <th>View</th>\n                            </tr></thead>\n                            <tbody>\n                            <tr *ngFor=\"let item of charities\">\n                                <td>{{item.charity_data.address}}</td>\n                                <td>{{item.charity_data.category}}</td>\n                                <td>{{item.charity_data.name}}</td>\n                                <td>{{item.charity_data.needed_aid}}</td>\n                                <td>{{item.charity_data.phone}}</td>\n                                <td>{{item.charity_data.verified}}</td>\n                                <td>{{item.charity_data.website}}</td>   \n                                <td> <a [routerLink]=\"['/charts']\" [queryParams]=\"{ charity_id: item.Key }\" class=\"btn btn-primary\">View</a> </td>  \n                            </tr>\n                    \n                            </tbody>\n                        </table>\n                      \n            </div>\n                \n\n        </div>\n    </div>\n    <hr>\n\n"
...
var DashboardComponent = (function () {
    function DashboardComponent(db, router) {
        var _this = this;
        this.db = db;
        this.router = router;
        this.alerts = [];
        ...
        this.root_ref.on("value", function (snap) {
            ...
            snap.forEach(function (childSnap) {
                ...
                var charity_obj = { Key: childKey, charity_data: childData };
                charities.push(charity_obj);
            });
            _this.charities = charities;
            console.log(_this.charities);
        });
    }
