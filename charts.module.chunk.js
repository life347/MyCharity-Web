...
module.exports = "<style>\n        #delete_modal{position:absolute;top:5px;left:50%;}\n        \n</style>\n<div [@routerTransition] id=\"body\">\n    <app-page-header [heading]=\"'Charts'\" [icon]=\"'fa-bar-chart-o'\"></app-page-header>\n        <div class=\"row\">\n                <div class=\"col-md-4\">\n                        <img class=\"img-thumbnail\" src=\"{{charity_details.picture}}\"  style=\"width:300px;height:300px;\" alt=\"\">\n                </div>\n                <div class=\"col-md-4\">\n                    <div id=\"display_record_div\">\n                            <h1>{{charity_details.name}}</h1>\n                            <p><b>Description: </b>{{charity_details.description}}</p>\n                            <p><b>Phone: </b>{{charity_details.phone}}</p>\n                            <p><b>Status: </b>{{charity_details.verified}}</p>\n                            <p><b>Needed Aid: </b>{{charity_details.needed_aid}}</p>\n                            <p><b>Category: </b>{{charity_details.category}}</p>\n                            <p><b>Latitude: </b>{{charity_details.location_lat}}</p>\n                            <p><b>Longitude: </b>{{charity_details.location_lon}}</p>\n                            \n                    </div>\n                    \n                    <div id=\"update_record_div\">\n                        <h1>Update Record</h1>\n                        \n                                <label>Person Name: </label> <input type=\"text\" id=\"in_name\" value=\"{{charity_details.name}}\" class=\"form-control\"> <br>\n                                <label>Category: </label> <input type=\"text\" id=\"in_category\" value=\"{{charity_details.category}}\" class=\"form-control\"> <br>\n                                <label>Address: </label> <input type=\"text\" id=\"in_address\" value=\"{{charity_details.address}}\" class=\"form-control\"> <br>\n                                <label>Description: </label> <input type=\"text\" id=\"in_description\" value=\"{{charity_details.description}}\" class=\"form-control\"> <br>\n                                <label>Needed Aid: </label> <input type=\"text\" id=\"in_aid\" value=\"{{charity_details.needed_aid}}\" class=\"form-control\"><br>\n                                <label>Website: </label> <input type=\"text\" id=\"in_website\" value=\"{{charity_details.website}}\" class=\"form-control\"> <br>\n                                <label>Phone: </label> <input type=\"text\" id=\"in_phone\" value=\"{{charity_details.phone}}\" class=\"form-control\"><br>\n                                <label>Location: </label> <input type=\"text\" id=\"in_location\" value=\"{{charity_details.location_lat}} , {{charity_details.location_lon}}\" class=\"form-control\"><br>\n                                <button (click)=\"update()\" class=\"btn btn-primary\">UPDATE</button>                    \n                    </div>\n                    \n\n                </div>\n                <div class=\"col-md-4\">\n                    <button class=\"btn btn-warning btn-block\"  (click)=\"show_update()\">UPDATE</button>\n                    <!-- <button class=\"btn btn-danger btn-block\" (click)=\"showModal()\" >DELETE</button> -->\n                   \n                </div>\n        </div>\n</div>\n<button type=\"button\" class=\"btn btn-danger btn-xs\" (click)=\"showModal()\"><i class=\"fa fa-trash-o\"></i> </button>\n<div id=\"delete_modal\">\n                <div class=\"modal-dialog\">\n                    <div class=\"modal-content\">\n                        <div class=\"modal-header\">\n                            Delete Confirmation\n                        </div>\n                        <div class=\"modal-body\">\n                            Are you sure ?\n                        </div>\n                        <div class=\"modal-footer\">\n                            <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\">Cancel</button>\n                            <a class=\"btn btn-danger btn-ok\" (click)=\"delete()\">Delete</a>\n                        </div>\n                    </div>\n                </div>\n            </div>\n\n"
...
var ChartsComponent = (function () {
    function ChartsComponent(route, db, router) {
        this.route = route;
        this.db = db;
        this.router = router;
    ...
    ChartsComponent.prototype.ngOnInit = function () {
        ...
        this.route
            ...
            _this.charity_id = params["charity_id"];
            _this.root_ref = _this.db.database.ref().child("charities").child(_this.charity_id);
        });
        this.root_ref.on("value", function (snap) {
            _this.charity_details = snap.val();
            console.log("Details: ", _this.charity_details);
        });
        $("#delete_modal").hide();
        $("#body").click(function () {
            $("#body").css("opacity", "1");
    ...
    ChartsComponent.prototype.show_update = function () {
        $("#display_record_div").hide();
        $("#update_record_div").fadeIn();
    };
    ChartsComponent.prototype.update = function () {
        this.root_ref.child("address").set($("#in_address").val());
        this.root_ref.child("category").set($("#in_category").val());
        this.root_ref.child("description").set($("#in_description").val());
        this.root_ref.child("name").set($("#in_name").val());
        this.root_ref.child("needed_aid").set($("#in_aid").val());
        this.root_ref.child("phone").set($("#in_phone").val());
        this.root_ref.child("website").set($("#in_website").val());
        var location_string = $("#in_location").val();
        var location_array = location_string.split(',');
        this.root_ref.child("location_lat").set(location_array[0]);
        this.root_ref.child("location_lon").set(location_array[1]);
        $("#update_record_div").hide();
        $("#display_record_div").fadeIn();
    };
    ChartsComponent.prototype.delete_record = function () {
        $("#deleteModal").modal();
    };
    ChartsComponent.prototype.showModal = function () {
        $("#body").css("opacity", "0.5");
        $("#delete_modal").fadeIn();
    };
    ChartsComponent.prototype.delete = function () {
        this.root_ref.remove();
